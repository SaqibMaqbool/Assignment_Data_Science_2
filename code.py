...
sheet_name = 'Data'
new_cols = ['Country Name', '2014', '2015', '2016', '2017', '2018', '2019', '2020', '2021', '2022']
countries = ['Brazil', 'Nigeria', 'Australia', 'Canada', 'South Africa', 'China', 'India', 'United States', 'Germany', 'France', 'United Kingdom', 'Japan', 'Mexico', 'Indonesia', 'Argentina']
...
data_Australia = {
    'Urban pop. growth': data_arable_land_transpose['Australia'],
    'Electricity production': data_electricity_transpose['Australia'],
    'Agric. forestry and Fisheries': data_agriculture_transpose['Australia'],
    'CO2 Emissions': data_CO2_transpose['Australia'],
    'Forest Area': data_forest_area_transpose['Australia'],
    'GDP Annual Growth': data_gdp_transpose['Australia']
}
df_australia = pd.DataFrame(data_Australia)

# Display the dataframe and correlation matrix Australia
print(df_australia)
corr_australia = df_australia.corr()
print(corr_australia)

# Display the correlation heatmap for Australia
correlation_heatmap(df_australia, corr_australia, 'Australia')
...
width_arable = 0.2
y_data_arable = [
    data_arable_land['2019'],
    data_arable_land['2020'],
    data_arable_land['2021'],
    data_arable_land['2022']
]
y_label_arable = '% of Land Area'
label_arable = ['Year 2019', 'Year 2020', 'Year 2021', 'Year 2022']
